                ...
                <header className="topbar">
                    <nav className="navbar top-navbar navbar-expand-md navbar-light">                  
                        ...
                        <ul className="navbar-nav mr-auto mt-md-0">
                            <li className="nav-item"> <a href="#" onClick={this.props.handleClickMob} className="nav-link nav-toggler hidden-md-up text-muted waves-effect waves-dark" ><i className="mdi mdi-menu" /></a> </li>
